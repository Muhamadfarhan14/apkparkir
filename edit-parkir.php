<?php 
  include('koneksi.php');
  $id = $_GET['id'];
  $query = "SELECT * FROM tbl_parkiran WHERE id_parkir = $id LIMIT 1";
            ...
            <div class="card-body">
              <form action="update.php" method="POST">
                ...
                <div class="form-group">
                  <label>Plat</label>
                  <input type="text" name="plat_nomer" value="<?php echo $row['plat_nomer'] ?>" placeholder="Masukkan Plat" class="form-control">
